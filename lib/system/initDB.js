...
function initDB(m, client) {
  ...
  settings.self ??= false
  settings.prefijo ??= ['/', '.', '#', '!']
  settings.id ??= '120363424677971125@newsletter'
  settings.nameid ??= '（´•̥̥̥ω•̥̥̥`）♡ LAYLA-AI ♡（´•̥̥̥ω•̥̥̥`）'
  settings.link ??= 'https://nexevo.onrender.com'
  settings.banner ??= 'https://files.catbox.moe/v82s07.jpg'
  
  settings.icon ??= 'https://files.catbox.moe/ig5ka9.jpg'
  settings.currency ??= 'Coins'
  settings.namebot ??= 'LAYLA-AI - 2026 '
  settings.namebot2 ??= 'Layla-AI'
